...
During integration, the first focused 2D invocation also timed out while launching Chrome inside
the restricted process sandbox. It passed without code changes when rerun with local Chrome
permission.
