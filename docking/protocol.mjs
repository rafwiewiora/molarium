...
export const MOLARIUM_POSE_PROPAGATION_PROTOCOL = Object.freeze({
  ...
  novelty:Object.freeze({
    ...
    molariumChanges:Object.freeze([
      ...
      'a deleted ligand contact participant can transfer only to an exact compatible feature created at the same recorded edit boundary',
  ...
  sampling:Object.freeze({
    ...
    stages:Object.freeze([
      ...
      'post-sanitization exact-feature remapping for captured contacts affected by the graph edit',
  ...
  contactFeatureMapping:Object.freeze({
    ...
    ligandEligibility:'same donor/acceptor role, element, charge, aromaticity, heavy-neighbor signature, and captured feature type',
    ...
    ambiguousCandidateAction:'require an explicit user selection or omission',
    zeroCandidateAction:'mark unavailable; never weaken the feature definition',
    ...
    subsequentEditRule:'an unresolved candidate set retains its originating feature signature, boundary, cumulative live edit region, and candidates; later edits revalidate those exact identities',
  ...
  requiredContactGeometry:Object.freeze({
    ...
    deletedLigandParticipant:'apply exact-feature-edit-boundary/v2 after sanitization; otherwise omit with ligand-feature-unavailable audit record',
  }),
  exclusions:Object.freeze([
    ...
    'replacement of a deleted reference contact without exact feature and edit-boundary evidence',
  ]),
  implementation:Object.freeze({
