...
export const MOLARIUM_POSE_PROPAGATION_PROTOCOL = Object.freeze({
  ...
  contactFeatureMapping:Object.freeze({
    ...
    editBoundaryRule:'the removed and replacement features must connect to the same nonempty surviving designAtomId boundary',
    ...
    subsequentEditRule:'an unresolved candidate set retains its originating feature signature and boundary; later edits revalidate those exact candidate identities',
    historyRule:'undo and redo restore molecular graph, selected contacts, remaps, and unresolved proposals atomically',
    provenance:'record the complete remap chain, source and replacement atom IDs, exact signatures, boundary IDs, candidate set, topology hashes, decision, and time',
  }),
  ...
  requiredContactGeometry:Object.freeze({
    ...
    deletedLigandParticipant:'apply exact-feature-edit-boundary/v1 after sanitization; otherwise omit with ligand-feature-unavailable audit record',
  }),
