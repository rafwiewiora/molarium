...
export function promotionStages(options) {
  ...
  return Object.freeze([
    ...
    { id:'install-interface-render',
      description:'Install only the accepted Local Lab interface render in public media',
      ...command(process.execPath, ['scripts/install-sos1-interface-render.mjs',
