...
const ACTIONS = Object.freeze({
  ...
  'pose.setContact': Object.freeze({ description:'Require or omit one captured contact hypothesis.',
    arguments:Object.freeze({ contactId:'captured contact ID; alternative to contactLabel',
      contactLabel:'exact unique captured label; alternative to contactId', required:'boolean',
      ifAbsent:'optional record-omission, only with contactLabel and required:false' }) }),
