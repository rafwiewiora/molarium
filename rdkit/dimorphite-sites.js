/*
 * Empirical ionizable-site definitions from Dimorphite-DL 2.0.2.
 * Upstream commit: 1166e1f7b4b2f792a02867636af4af49555a8f11
 * Source: dimorphite_dl/smarts/site_substructures.smarts
 * License: Apache-2.0; see licenses/DIMORPHITE-DL-LICENSE.txt.
 *
 * Order is significant: once a higher-priority SMARTS matches, every atom in
 * that match is protected from lower-priority definitions.
 */
self.MOLARIUM_DIMORPHITE = Object.freeze({
  version: '2.0.2',
  revision: '1166e1f7b4b2f792a02867636af4af49555a8f11',
  license: 'Apache-2.0',
  source: 'https://github.com/durrantlab/dimorphite_dl',
  siteData: String.raw`*Azide	[N+0:1]=[N+:2]=[N+0:3]-[H]	2	4.65	0.07071067811865513
